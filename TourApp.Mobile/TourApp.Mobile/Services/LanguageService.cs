    ...
    public static class LanguageService
    {
        ...
        private static void CreateBuiltInFallback()
        {
            var fallbackDict = new Dictionary<string, string>
            {
                ...
                // PaymentPage keys
                ["PaymentTitle"] = "Thanh toán QR", ["PaymentHeader"] = "Thanh toán đặt tour", ["PaymentSubtitle"] = "Chọn phương thức thanh toán",
                ["BookingInfoTitle"] = "Thông tin đặt tour", ["BookingCodeLabel"] = "Mã booking:", ["NumberOfPeopleLabel"] = "Số người:",
                ["TotalPaymentLabel"] = "Tổng thanh toán", ["QRCodeTitle"] = "Mã QR thanh toán",
                ["QRCodeInstruction"] = "Sử dụng app ngân hàng hoặc ví điện tử để quét", ["QRCodeExpiry"] = "Mã QR hết hạn sau:",
                ["PaymentMethods"] = "Phương thức thanh toán", ["PayWithVNPay"] = "💳 Thanh toán VNPay", ["PayWithMomo"] = "📱 Ví Momo", ["PayWithPayPal"] = "🅿️ PayPal",
                ["CancelPayment"] = "Hủy thanh toán", ["CancelPaymentConfirm"] = "Bạn có chắc muốn hủy thanh toán?\nBooking của bạn sẽ bị hủy.",
                ["BookingNotFound"] = "Không tìm thấy thông tin booking", ["LoadBookingError"] = "Không thể tải thông tin booking",
                ["QRExpired"] = "Mã QR đã hết hạn, vui lòng thử lại", ["PaymentFailed"] = "Thất bại",
                ["PaymentProcessError"] = "Có lỗi xảy ra khi xử lý thanh toán", ["BookingCancelled"] = "Người dùng hủy thanh toán",
                ["CancelSuccess"] = "Booking đã được hủy thành công", ["CancelBookingError"] = "Không thể hủy booking",
                // PaymentSuccessPage keys
                ["PaymentSuccessTitle"] = "Thanh toán thành công", ["PaymentSuccessHeader"] = "Thanh toán thành công!",
                ["TourLabel"] = "Tour:", ["DepartureDateLabel"] = "Ngày khởi hành:", ["TransactionID"] = "Mã giao dịch:",
                ["ViewBookingHistory"] = "Xem lịch sử đặt tour", ["BackToHome"] = "Về trang chủ", ["PeopleSuffix"] = " người",
            ...
            var enDict = new Dictionary<string, string>
            {
                ...
                // PaymentPage keys
                ["PaymentTitle"] = "QR Payment", ["PaymentHeader"] = "Tour Payment", ["PaymentSubtitle"] = "Select payment method",
                ["BookingInfoTitle"] = "Booking Info", ["BookingCodeLabel"] = "Booking Code:", ["NumberOfPeopleLabel"] = "People:",
                ["TotalPaymentLabel"] = "Total Payment", ["QRCodeTitle"] = "Payment QR Code",
                ["QRCodeInstruction"] = "Use banking app or e-wallet to scan", ["QRCodeExpiry"] = "QR code expires in:",
                ["PaymentMethods"] = "Payment Methods", ["PayWithVNPay"] = "💳 Pay with VNPay", ["PayWithMomo"] = "📱 Momo Wallet", ["PayWithPayPal"] = "🅿️ PayPal",
                ["CancelPayment"] = "Cancel Payment", ["CancelPaymentConfirm"] = "Are you sure you want to cancel payment?\nYour booking will be cancelled.",
                ["BookingNotFound"] = "Booking information not found", ["LoadBookingError"] = "Cannot load booking information",
                ["QRExpired"] = "QR code has expired, please try again", ["PaymentFailed"] = "Failed",
                ["PaymentProcessError"] = "An error occurred while processing payment", ["BookingCancelled"] = "User cancelled payment",
                ["CancelSuccess"] = "Booking cancelled successfully", ["CancelBookingError"] = "Cannot cancel booking",
                // PaymentSuccessPage keys
                ["PaymentSuccessTitle"] = "Payment Successful", ["PaymentSuccessHeader"] = "Payment successful!",
                ["TourLabel"] = "Tour:", ["DepartureDateLabel"] = "Departure Date:", ["TransactionID"] = "Transaction ID:",
                ["ViewBookingHistory"] = "View Booking History", ["BackToHome"] = "Back to Home", ["PeopleSuffix"] = " people",
                // EditProfilePage keys
            ...
            var zhDict = new Dictionary<string, string>(enDict)
            {
                ...
                // PaymentPage keys
                ["PaymentTitle"] = "QR支付", ["PaymentHeader"] = "旅游付款", ["PaymentSubtitle"] = "选择付款方式",
                ["BookingInfoTitle"] = "预订信息", ["BookingCodeLabel"] = "预订代码：", ["NumberOfPeopleLabel"] = "人数：",
                ["TotalPaymentLabel"] = "总付款", ["QRCodeTitle"] = "付款二维码",
                ["QRCodeInstruction"] = "使用银行应用或电子钱包扫描", ["QRCodeExpiry"] = "二维码过期时间：",
                ["PaymentMethods"] = "付款方式", ["PayWithVNPay"] = "💳 VNPay支付", ["PayWithMomo"] = "📱 Momo钱包", ["PayWithPayPal"] = "🅿️ PayPal",
                ["CancelPayment"] = "取消付款", ["CancelPaymentConfirm"] = "您确定要取消付款吗？\n您的预订将被取消。",
                ["BookingNotFound"] = "找不到预订信息", ["LoadBookingError"] = "无法加载预订信息",
                ["QRExpired"] = "二维码已过期，请重试", ["PaymentFailed"] = "失败",
                ["PaymentProcessError"] = "处理付款时发生错误", ["BookingCancelled"] = "用户取消付款",
                ["CancelSuccess"] = "预订已成功取消", ["CancelBookingError"] = "无法取消预订",
                // PaymentSuccessPage keys
                ["PaymentSuccessTitle"] = "支付成功", ["PaymentSuccessHeader"] = "支付成功！",
                ["TourLabel"] = "旅游：", ["DepartureDateLabel"] = "出发日期：", ["TransactionID"] = "交易编号：",
                ["ViewBookingHistory"] = "查看预订历史", ["BackToHome"] = "返回首页", ["PeopleSuffix"] = "人",
                // EditProfilePage keys
            ...
            var jaDict = new Dictionary<string, string>(enDict)
            {
                ...
                // PaymentPage keys
                ["PaymentTitle"] = "QR決済", ["PaymentHeader"] = "ツアー支払い", ["PaymentSubtitle"] = "支払い方法を選択",
                ["BookingInfoTitle"] = "予約情報", ["BookingCodeLabel"] = "予約コード：", ["NumberOfPeopleLabel"] = "人数：",
                ["TotalPaymentLabel"] = "合計金額", ["QRCodeTitle"] = "支払いQRコード",
                ["QRCodeInstruction"] = "銀行アプリまたは電子ウォレットでスキャン", ["QRCodeExpiry"] = "QRコードの有効期限：",
                ["PaymentMethods"] = "支払い方法", ["PayWithVNPay"] = "💳 VNPayで支払い", ["PayWithMomo"] = "📱 Momoウォレット", ["PayWithPayPal"] = "🅿️ PayPal",
                ["CancelPayment"] = "支払いをキャンセル", ["CancelPaymentConfirm"] = "支払いをキャンセルしますか？\n予約がキャンセルされます。",
                ["BookingNotFound"] = "予約情報が見つかりません", ["LoadBookingError"] = "予約情報を読み込めません",
                ["QRExpired"] = "QRコードの有効期限が切れました。もう一度お試しください。", ["PaymentFailed"] = "失敗",
                ["PaymentProcessError"] = "支払い処理中にエラーが発生しました", ["BookingCancelled"] = "ユーザーが支払いをキャンセル",
                ["CancelSuccess"] = "予約が正常にキャンセルされました", ["CancelBookingError"] = "予約をキャンセルできません",
                // PaymentSuccessPage keys
                ["PaymentSuccessTitle"] = "支払い完了", ["PaymentSuccessHeader"] = "支払いが完了しました！",
                ["TourLabel"] = "ツアー：", ["DepartureDateLabel"] = "出発日：", ["TransactionID"] = "取引ID：",
                ["ViewBookingHistory"] = "予約履歴を見る", ["BackToHome"] = "ホームへ戻る", ["PeopleSuffix"] = "人",
                // EditProfilePage keys
